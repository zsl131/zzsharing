...
public class BaseSpecification<T> implements Specification<T> {
    ...
    public BaseSpecification(String key, String opt, String value) {
        criteria = new SearchSpe(key, opt, value);
    }

    private SearchSpe criteria;
    public BaseSpecification(SearchSpe criteria) {
